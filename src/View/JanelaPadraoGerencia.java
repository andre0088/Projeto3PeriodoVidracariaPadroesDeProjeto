...
public abstract class JanelaPadraoGerencia extends JanelaVidro{
	
	private Point point = new Point();
	
	public JanelaPadraoGerencia(String title) {
	...
	public final void adicionarJMenus() {
		...
		if(logado.getCargo().equals("Admin") || logado.getCargo().equals("Gerente")) {
		...
		menuBar.add(logout);
		if(logado.getCargo().equals("Mão de obra")==false) {
	...
	public abstract void adicionarJTable();
